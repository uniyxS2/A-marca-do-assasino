...
def ato1():
    ...
    while True:
        ...
        if escolha == "1":
            ...
            linha()
            moldura("Kaori revela: ""Demi dizia ouvir passos durante a noite.")
            time.sleep(1)
    ...
    while True:
        ...
        if escolha2 == "1":
            ...
            linha()
            moldura("o jardim, encontram uma adaga com a marca de assassino:")
            time.sleep(1)
...
def ato4():
    ...
    while True:
        ...
        if escolha6 == 1:
            ...
            time.sleep(1.2)
            moldura("no dia seguinte, por que você foi visto perto da prefeitura.")
            time.sleep(1.3)
            linha()
...
def ato8():
    ...
    linha()
    moldura("ATO 8 — A PREPARAÇÃO\n")
    linha()
    
    linha()
    moldura("Você passa as próximas semanas reunindo informações.")
    time.sleep(1)
    moldura("culpa pela morte de tantos inocentes pesa em seus ombros.")
    time.sleep(1.2)
    ...
    if escolha16 == "1":
        ...
        linha()
          ...
          time.sleep(1.2)
          moldura("dependendo do que aconteceu antes, oferece o que sabe do culto")
          time.sleep(1.3
    ...
    escolha19 = input("Escolha uma opção: ")
...
def ato10():
    ...
    if entrada_abadia == "1":
        linha()
        moldura("Você força a entrada. o som ecoa peka abadia")
        time.sleep(1)
        linha
    ...
    linha()
    moldura("Já dentro da abadia, você observa uma camara de meditação, bem proxima")
    time.sleep(1)
    ...
    limpar()
       ...
       # =========================
    # ATO 11 — AS PROVAS ESQUECIDAS
    # =========================

def ato11():
    
    linha()
    moldura("ATO 11 — AS PROVAS ESQUECIDAS")
    linha()

    moldura("Você continua pelo túnel enquanto o som dos cavaleiros invade a abadia.")
    time.sleep(1)
    moldura("A pequena caixa ainda está em sua mão.")
    time.sleep(1.2)
    moldura("O pergaminho também.")
    time.sleep(1.3)
    moldura("A frase não sai da sua cabeça:")
    time.sleep(1.4)
    moldura('"O verdadeiro rei ainda está vivo."')
    time.sleep(1.5)
    ...
    linha()
    moldura("Depois de alguns minutos, o túnel termina em uma pequena sala subterrânea.")
    time.sleep(1)
    moldura("Você acende uma vela.")
    time.sleep(1.2)
    moldura("A sala parece abandonada há anos.")
    time.sleep(1.3)
    moldura("Mas algo chama sua atenção.")
    time.sleep(1.4)
    ...
    moldura("Sobre uma mesa existem vários documentos antigos.")
    time.sleep(1)
    moldura("Alguns estão cobertos de poeira.")
    time.sleep(1.2)
    moldura("Outros parecem ter sido mexidos recentemente.")
    time.sleep(1.3)
    moldura("Você se aproxima.")
    time.sleep(1.4)
    ...
    moldura("Entre os papéis, encontra três coisas que podem ajudar na investigação:")
    time.sleep(1)
    moldura("Um registro sobre a morte do antigo rei.")
    time.sleep(1.2)
    moldura("Uma lista de nomes.")
    time.sleep(1.3)
    moldura("E uma carta com o selo real.")
    time.sleep(1.4)
    moldura("Você precisa descobrir qual delas pode revelar a verdade.")
    time.sleep(1.5)

    linha()
    moldura("O que você investiga?")
    linha()

    voce_abre_o_documento = False
    data_da_morte_registrada = False
    existe_algo_estranho = False

    while True:

        moldura("1 — O registro da morte do rei")
        moldura("2 — A lista de nomes")
        moldura("3 — A carta com o selo real")
        ...
        if escolha == "1":
            ...
            voce_abre_o_documento = True

            linha()
            moldura("Você abre o documento.")
            time.sleep(1)
            moldura("A data da morte está registrada.")
            time.sleep(1.2)
            moldura("Mas existe algo estranho.")
            time.sleep(1.3)
            linha()
            ...
            linha()
            moldura("O documento afirma que o corpo do rei nunca foi apresentado ao povo.")
            time.sleep(1)
            moldura("Apenas seus conselheiros confirmaram sua morte.")
            time.sleep(1.2)
            moldura("Você procura mais informações.")
            time.sleep(1.3)
            linha()
            ...
            linha()
            moldura("Algumas páginas foram arrancadas.")
            time.sleep(1)
            moldura("Alguém claramente não queria que a verdade fosse descoberta.")
            time.sleep(1.5)
            linha()
        ...
        # =========================
            ...
            data_da_morte_registrada = True

            linha()
            moldura("Você examina a lista.")
            time.sleep(1)
            moldura("São nomes de pessoas que ocupavam cargos importantes no reino há quinze anos.")
            time.sleep(1.5)
            linha()
            ...
            linha()
            moldura("Alguns estão riscados.")
            time.sleep(1)
            moldura("Outros estão marcados com pequenas anotações.")
            time.sleep(1.5)
            linha()
            ...
            linha()
            moldura("No final da lista existe um nome que você reconhece.")
            time.sleep(1)
            moldura("É o sobrenome de uma das vítimas dos assassinatos.")
            time.sleep(1.5)
            moldura("Talvez ela não tenha sido escolhida por acaso.")
            time.sleep(1.7)
            linha()
        ...
        # =========================
            ...
            existe_algo_estranho = True

            linha()
            moldura("Você abre a carta cuidadosamente.")
            time.sleep(1)
            moldura("Ela foi escrita poucos dias antes da suposta morte do rei.")
            time.sleep(1.5)
            linha()
            ...
            linha()
            moldura("O conteúdo é curto:")
            time.sleep(1)
            moldura('"Se alguma coisa acontecer comigo, não confie nos homens que estiverem ao meu lado."')
            time.sleep(1.3)
            linha()
            ...
            linha()
            moldura("Não há assinatura.")
            time.sleep(1)
            moldura("Mas o selo confirma que a carta pertenceu à família real.")
            time.sleep(1.2)
            moldura("Você guarda o documento.")
            time.sleep(1.3)
            linha()
            ...
            linha()
            moldura("Você hesita por alguns segundos.")
            time.sleep(1)
            moldura("Não há tempo para pensar muito.")
            time.sleep(1.2)
            moldura("Escolha uma das provas.")
            time.sleep(.3)
            linha()

        if (
            voce_abre_o_documento
            and data_da_morte_registrada
            and existe_algo_estranho
        ):
            break
    ...
    linha()
    moldura("Agora existem mais perguntas do que respostas.")
    time.sleep(1)
    moldura("Se o rei realmente morreu, por que deixou uma mensagem como essa?")
    time.sleep(1.2)
    moldura("E por que uma das vítimas estava ligada às pessoas que estavam próximas dele?")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("Um barulho metálico ecoa pelo túnel.")
    linha()
    ...
    linha()
    moldura("Você apaga a vela.")
    time.sleep(1)
    moldura("Passos começam a se aproximar.")
    time.sleep(1.2)
    moldura("Você segura a adaga.")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("Os passos param diante da porta.")
    time.sleep(1)
    moldura("Silêncio.")
    time.sleep(1.5)
    linha()
    ...
    linha()
    moldura("Então alguém tenta abrir.")
    linha()
    ...
    linha()
    moldura("Você olha ao redor da sala.")
    linha()

    moldura("Existe uma pequena janela na parede.")
    time.sleep(1)
    moldura("Uma segunda saída escondida atrás de algumas caixas.")
    time.sleep(1.2)
    moldura("E a porta pela qual entrou.")
    time.sleep(1.3)
    linha()

    moldura("O que você faz?")
    linha()

    moldura("1 — Se esconder na sala")
    moldura("2 — Usar a passagem escondida")
    moldura("3 — Esperar atrás da porta")
    ...
    if escolha2 == "1":
        ...
        linha()
        moldura("Você permanece em silêncio e espera para descobrir quem está do outro lado.")
        linha()
        ...
        linha()
        moldura("Você se esconde atrás de algumas caixas.")
        time.sleep(1)
        moldura("A maçaneta se move lentamente.")
        time.sleep(1.2)
        moldura("A porta começa a abrir.")
        time.sleep(1.3)
        linha()
        ...
        linha()
        moldura("Você move as caixas e encontra um pequeno corredor.")
        time.sleep(1)
        moldura("O corredor parece levar para fora da abadia.")
        time.sleep(1.2)
        linha()
        ...
        linha()
        moldura("Você entra rapidamente na passagem.")
        time.sleep(1)
        moldura("Atrás de você, a porta da sala começa a se abrir.")
        time.sleep(1.2)
        linha()
        ...
        linha()
        moldura("Você segura a adaga e se posiciona ao lado da entrada.")
        time.sleep(1)
        moldura("Se a pessoa entrar, você poderá descobrir quem ela é antes que ela perceba sua presença.")
        time.sleep(1.2)
        linha()
        ...
        linha()
        moldura("A maçaneta começa a girar.")
        time.sleep(1.2)
        moldura("Você prende a respiração.")
        time.sleep(1.3)
        linha()
        ...
        moldura("Você hesita.")
        time.sleep(1)
        moldura("Não há tempo para ficar parado.")
        time.sleep(1.2)
        linha()
    ...
    linha()
    moldura("Você precisa tomar uma decisão rapidamente.")
    linha()

    moldura("Os passos começam novamente.")
    time.sleep(1)
    moldura("Dessa vez, estão se afastando.")
    time.sleep(1.2)
    linha()
    ...
    linha()
    moldura("Quem quer que esteja no túnel sabe que alguém entrou naquela sala.")
    linha()
    ...
    linha()
    moldura("E agora você percebe uma coisa:")
    time.sleep(1)
    moldura("Alguém está tentando apagar as provas antes que você descubra a verdade.")
    time.sleep(1.2)
    linha()
    ...
    def ato12():
     ...
     linha()
    moldura("Você deixa a sala subterrânea para trás.")
    time.sleep(1)
    moldura("Os passos no túnel já desapareceram.")
    time.sleep(1.2)
    moldura("A abadia ficou em silêncio novamente.")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("Você segue pelo corredor estreito até encontrar")
    time.sleep(1)
    moldura("uma pequena escada que leva para outra parte do prédio.")
    time.sleep(1.2)
    moldura("No fim dela existe uma sala antiga.")
    time.sleep(1.3)
    ...
    linha()
    moldura("Sobre uma mesa encontra vários documentos espalhados.")
    time.sleep(1)
    moldura("Alguns possuem o mesmo selo real encontrado na carta.")
    time.sleep(1.2)
    moldura("Você começa a investigar.")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("Entre os papéis, encontra uma lista mais antiga.")
    time.sleep(1)
    moldura("Dessa vez, os nomes estão acompanhados de datas e cargos.")
    time.sleep(1.2)
    moldura("Você reconhece alguns deles.")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("São os mesmos nomes encontrados na lista da sala subterrânea.")
    time.sleep(1)
    moldura("Mas existe algo diferente.")
    time.sleep(1.2)
    moldura("Um dos nomes foi circulado várias vezes.")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("O antigo conselheiro responsável pela segurança do rei.")
    time.sleep(1)
    moldura("Ao lado do nome existe uma anotação:")
    time.sleep(1.2)
    moldura("“Última pessoa vista com o rei.”")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("Você continua procurando.")
    time.sleep(1)
    moldura("Encontra outro documento.")
    time.sleep(1.2)
    moldura("É um relatório sobre a noite em que o rei supostamente morreu.")
    time.sleep(1.3)
    linha()
    
    linha()
    moldura("Segundo o relatório, houve uma revolta dentro do castelo naquela noite.")
    time.sleep(1)
    moldura("Mas uma informação chama sua atenção.")
    time.sleep(1.2)
    linha()
    ...
    linha()
    moldura("O relatório diz que a porta dos aposentos reais foi encontrada trancada por dentro.")
    time.sleep(1)
    moldura("Você franze a testa.")
    time.sleep(1.2)
    moldura("Se ninguém entrou…")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("Como alguém poderia ter matado o rei?")
    time.sleep(1)
    moldura("Você procura mais informações.")
    time.sleep(1.2)
    moldura("Antes que consiga encontrar uma resposta, ouve vozes no corredor.")
    time.sleep(1.3)
    linha()
    
    moldura("Você rapidamente se esconde atrás de uma estante.")
    time.sleep(1)
    moldura("Dois homens entram na sala.")
    time.sleep(1.2)
    moldura("Um deles segura vários documentos.")
    time.sleep(1.3)
    linha()
    ...
    linha()
    moldura("— Encontraram a passagem — diz o primeiro.")
    time.sleep(1)
    moldura("— Então precisamos retirar tudo daqui antes que ele descubra.")
    time.sleep(1.2)
    linha()
    ...
    moldura("Você prende a respiração.")
    time.sleep(1)
    moldura("O segundo homem coloca os documentos sobre a mesa.")
    time.sleep(1.2)
    linha()
    ...
    linha()
    moldura("— E o investigador?")
    time.sleep(1)
    moldura("— Ainda está procurando.")
    time.sleep(1.2)
    moldura("— Ele já descobriu sobre o conselheiro?")
    time.sleep(1.3)
    
    moldura("O homem fica em silêncio por alguns segundos.")
    time.sleep(1)
    moldura("— Ainda não")
    time.sleep(1.2
    moldura("Você sente o coração acelerar.")
    time.sleep(1.2)
    linha()
    ...
    linha()
    moldura("Eles estão falando sobre você.")
    time.sleep(1)
    moldura("Mas agora existe uma nova pista.")
    time.sleep(1.2)
    moldura("O conselheiro.")
    time.sleep(1.3)
    moldura("E talvez ele seja a ligação entre a morte do rei e os assassinatos.")
    time.sleep(1.4)
    moldura("Os dois homens começam a sair.")
    time.sleep(1.5)
    linha()
    ...
    linha()
    moldura("Você precisa decidir rapidamente.")
    time.sleep(1)
    moldura("O que você faz?")
    time.sleep(1.2)
    moldura("[1] Seguir os homens")
    moldura("[2] Investigar os documentos")
    moldura("[3] Tentar descobrir quem são")
    linha()
    
    escolha1 = input(VERMELHO + "\n              >>> " + RESET)
    
    if escolha1 == 1:
        
        linha()
        moldura("Você espera alguns segundos e sai silenciosamente atrás deles.")
        time.sleep(1)
        moldura("Talvez eles levem você até alguém importante.")
        time.sleep(1.2)
        moldura("Você pensa que eles nao estão ouvindo Você")
        time.sleep(1.3)
        linha()
        
        linha()
        moldura("Passos vem ate você")
        time.sleep(1)
        moldura("derrepente algo agarra seu pescoco")
        time.sleep(1.2)
        moldura("você sente algo gelado em você")
        time.sleep(1.3)
        moldura("você morreu")
        time.sleep(1.4)
        linha()
        ...
        linha()
        moldura("Você permanece na sala e procura tudo")
        time.sleep(1)
        moldura("que estiver relacionado ao antigo conselheiro")
        time.sleep(1.2)
        moldura("Talvez encontre uma prova mais concreta")\
        time.sleep(1.3)
        linha()
        
        linha()
        moldura("Depois de um tempo os barulhos param")
        time.sleep(1)
        moldura("Os homens desaparecem.")
        time.sleep(1.2)
        moldura("Você olha novamente para os documentos sobre a mesa.")
        time.sleep(1.3)
        moldura("Pela primeira vez, a investigação parece formar uma linha.")
        time.sleep(1.4)
        linha()
        ...
        linha()
        moldura("Os assassinatos.")
        time.sleep(1)
        moldura("A Rosa Negra.")
        time.sleep(1.2)
        moldura("A morte do rei.")
        time.sleep(1.3)
        moldura("E o antigo conselheiro.")
        time.sleep(1.4)
        moldura("Talvez tudo esteja conectado.")
        time.sleep(1.5)
        moldura("Mas ainda falta descobrir uma coisa:")
        time.sleep(1.6)
        moldura("O que realmente aconteceu naquela noite, quinze anos atrás?")
        time.sleep(1.7)
        linha()
...
def ato13():
    ...
    linha()
    moldura("ATO 13 — O CONSELHEIRO DESAPARECIDO")
    linha()
...
def ato14():
    ...
    time.sleep(1)
    moldura("-Então save por que tentei imperdir Emi")
    time.sleep(1.2)
    linha()
    ...
    time.sleep(1)
    moldura("- o ultimo descendente chegou")
    time.sleep(1.2)
    linha()
    ...
    linha()
    moldura("O sangue de Emi pode interromper o ritual porque ela foi a ultima")
    time.sleep(1)
    ...
    escolhaato4 = input("Escolha uma opcao")
    ...
    if escolhaato4 == "1":
        ...
        linha()
        moldura("Kaori entrega o fracos")
        time.sleep(1)
    ...
    linha()
    moldura("A historia pode terminar de maneiras diferentes")
    time.sleep(1)
    moldura("Mas existe uma forma de acabar com tudo.")
    time.sleep(1.2)
    linha()
    
    linha()
    moldura("Você olha novamente para a chave.")
    time.sleep(1)
    moldura("E decide destruir o circulo")
    time.sleep(1.2)
    moldura("A pedra se parte.")
    time.sleep(1.3)
    linha()
...
def ato15():
    ...
    input("Pressione entern para continuar")
    limpar()
    ...
    linha()
    moldura("Pressione ENTER para continuar.")
    moldura(input())
    linha()
    time.sleep(2)
